...
const scrollHeader = () => {
	...
	//When the scroll id greater than 50 viewport height, and scroll-header class
	this.scrollY >= 50
...
const scrollUp = () => {
	...
	//When the scroll is higher than 350 vieport height, add the show-scroll class to
	this.scrollY >= 350
